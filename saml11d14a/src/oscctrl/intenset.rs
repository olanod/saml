...
pub type XOSCFAIL_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
...
pub type OSC16MRDY_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
...
pub type DFLLULPRDY_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
...
pub type DFLLULPLOCK_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
...
pub type DFLLULPNOLOCK_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
...
pub type DPLLLCKR_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
...
pub type DPLLLCKF_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
...
pub type DPLLLTO_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
...
pub type DPLLLDRTO_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
impl R {
