...
pub type PEREO0_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type PEREO1_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type PEREO2_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type PEREO3_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type PEREO4_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type PEREO5_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type PEREO6_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type PEREO7_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type CMPEO0_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type CMPEO1_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type TAMPEREO_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type OVFEO_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type TAMPEVEI_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
#[doc = "Field `PERDEO` reader - Periodic Interval Daily Event Output Enable"]
pub type PERDEO_R = crate::BitReader;
#[doc = "Field `PERDEO` writer - Periodic Interval Daily Event Output Enable"]
pub type PERDEO_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmpeo1(&mut self) -> CMPEO1_W<9> {
        CMPEO1_W::new(self)
    }
    #[doc = "Bit 14 - Tamper Event Output Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tampereo(&mut self) -> TAMPEREO_W<14> {
        TAMPEREO_W::new(self)
    }
    #[doc = "Bit 15 - Overflow Event Output Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn tampevei(&mut self) -> TAMPEVEI_W<16> {
        TAMPEVEI_W::new(self)
    }
    #[doc = "Bit 24 - Periodic Interval Daily Event Output Enable"]
    #[inline(always)]
    #[must_use]
    pub fn perdeo(&mut self) -> PERDEO_W<24> {
        PERDEO_W::new(self)
    }
