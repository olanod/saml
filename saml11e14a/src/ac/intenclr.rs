...
pub type COMP0_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
...
pub type COMP1_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
...
pub type WIN0_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
impl R {
