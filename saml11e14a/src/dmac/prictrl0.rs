...
pub type LVLPRI0_W<'a, const O: u8> = crate::FieldWriter<'a, PRICTRL0_SPEC, 3, O>;
...
pub type RRLVLEN0_W<'a, const O: u8> = crate::BitWriter<'a, PRICTRL0_SPEC, O>;
...
pub type LVLPRI1_W<'a, const O: u8> = crate::FieldWriter<'a, PRICTRL0_SPEC, 3, O>;
...
pub type RRLVLEN1_W<'a, const O: u8> = crate::BitWriter<'a, PRICTRL0_SPEC, O>;
...
pub type LVLPRI2_W<'a, const O: u8> = crate::FieldWriter<'a, PRICTRL0_SPEC, 3, O>;
...
pub type RRLVLEN2_W<'a, const O: u8> = crate::BitWriter<'a, PRICTRL0_SPEC, O>;
...
pub type LVLPRI3_W<'a, const O: u8> = crate::FieldWriter<'a, PRICTRL0_SPEC, 3, O>;
...
pub type RRLVLEN3_W<'a, const O: u8> = crate::BitWriter<'a, PRICTRL0_SPEC, O>;
impl R {
