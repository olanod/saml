...
pub type RESRDY_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
...
pub type OVERRUN_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
...
pub type WINMON_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
impl R {
