...
pub type RESRDY_W<'a, const O: u8> = crate::BitWriter<'a, INTFLAG_SPEC, O>;
...
pub type OVERRUN_W<'a, const O: u8> = crate::BitWriter<'a, INTFLAG_SPEC, O>;
...
pub type WINMON_W<'a, const O: u8> = crate::BitWriter<'a, INTFLAG_SPEC, O>;
impl R {
