...
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, OSC16MCTRL_SPEC, O>;
#[doc = "Field `FSEL` reader - Oscillator Frequency Selection"]
pub type FSEL_R = crate::FieldReader<FSELSELECT_A>;
...
impl crate::FieldSpec for FSELSELECT_A {
    type Ux = u8;
}
impl FSEL_R {
...
pub type FSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, OSC16MCTRL_SPEC, 2, O, FSELSELECT_A>;
...
pub type RUNSTDBY_W<'a, const O: u8> = crate::BitWriter<'a, OSC16MCTRL_SPEC, O>;
...
pub type ONDEMAND_W<'a, const O: u8> = crate::BitWriter<'a, OSC16MCTRL_SPEC, O>;
impl R {
