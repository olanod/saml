...
pub type MODE_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLA_SPEC, 2, O, MODESELECT_A>;
...
pub type PRESCSYNC_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLA_SPEC, 2, O, PRESCSYNCSELECT_A>;
...
pub type ONDEMAND_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
...
pub type PRESCALER_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CTRLA_SPEC, 3, O, PRESCALERSELECT_A>;
...
pub type ALOCK_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
...
pub type CAPTEN0_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
...
pub type CAPTEN1_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
...
pub type COPEN0_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
...
pub type COPEN1_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
...
impl CAPTMODE0_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<CAPTMODE0SELECT_A> {
        match self.bits {
...
pub type CAPTMODE0_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLA_SPEC, 2, O, CAPTMODE0SELECT_A>;
impl<'a, const O: u8> CAPTMODE0_W<'a, O> {
    #[doc = "Default capture"]
    #[inline(always)]
...
impl CAPTMODE1_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<CAPTMODE1SELECT_A> {
        match self.bits {
...
pub type CAPTMODE1_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLA_SPEC, 2, O, CAPTMODE1SELECT_A>;
impl<'a, const O: u8> CAPTMODE1_W<'a, O> {
    #[doc = "Default capture"]
    #[inline(always)]
    pub fn default(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn captmode0(&mut self) -> CAPTMODE0_W<24> {
        CAPTMODE0_W::new(self)
    }
    #[doc = "Bits 27:28 - Capture mode Channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn captmode1(&mut self) -> CAPTMODE1_W<27> {
