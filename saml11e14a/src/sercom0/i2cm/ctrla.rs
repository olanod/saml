...
pub type MODE_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLA_SPEC, 3, O>;
...
pub type PINOUT_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
#[doc = "Field `SDAHOLD` reader - SDA Hold Time"]
pub type SDAHOLD_R = crate::FieldReader;
#[doc = "Field `SDAHOLD` writer - SDA Hold Time"]
pub type SDAHOLD_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLA_SPEC, 2, O>;
...
pub type MEXTTOEN_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
...
pub type SEXTTOEN_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
#[doc = "Field `SPEED` reader - Transfer Speed"]
pub type SPEED_R = crate::FieldReader;
#[doc = "Field `SPEED` writer - Transfer Speed"]
pub type SPEED_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLA_SPEC, 2, O>;
...
pub type SCLSM_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
...
pub type INACTOUT_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLA_SPEC, 2, O>;
...
pub type LOWTOUTEN_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mexttoen(&mut self) -> MEXTTOEN_W<22> {
        MEXTTOEN_W::new(self)
    }
    #[doc = "Bit 23 - Slave SCL Low Extend Timeout"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn inactout(&mut self) -> INACTOUT_W<28> {
        INACTOUT_W::new(self)
    }
    #[doc = "Bit 30 - SCL Low Timeout Enable"]
    #[inline(always)]
