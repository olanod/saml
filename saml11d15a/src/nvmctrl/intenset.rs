...
pub type DONE_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
...
pub type PROGE_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
...
pub type LOCKE_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
...
pub type NVME_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
...
pub type KEYE_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
...
pub type NSCHK_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
impl R {
