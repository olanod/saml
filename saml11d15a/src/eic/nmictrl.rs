...
pub type NMISENSE_W<'a, const O: u8> = crate::FieldWriter<'a, NMICTRL_SPEC, 3, O, NMISENSESELECT_A>;
...
pub type NMIFILTEN_W<'a, const O: u8> = crate::BitWriter<'a, NMICTRL_SPEC, O>;
#[doc = "Field `NMIASYNCH` reader - Asynchronous Edge Detection Mode"]
pub type NMIASYNCH_R = crate::BitReader;
#[doc = "Field `NMIASYNCH` writer - Asynchronous Edge Detection Mode"]
pub type NMIASYNCH_W<'a, const O: u8> = crate::BitWriter<'a, NMICTRL_SPEC, O>;
impl R {
