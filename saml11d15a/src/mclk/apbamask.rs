...
pub type OSCCTRL__W<'a, const O: u8> = crate::BitWriter<'a, APBAMASK_SPEC, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn port_(&mut self) -> PORT__W<12> {
        PORT__W::new(self)
    }
    #[doc = "Bit 13 - AC APB Clock Enable"]
    #[inline(always)]
