...
pub type EVACT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, EVCTRL_SPEC, 3, O, EVACTSELECT_A>;
...
pub type TCINV_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
#[doc = "Field `TCEI` reader - TC Event Enable"]
pub type TCEI_R = crate::BitReader;
#[doc = "Field `TCEI` writer - TC Event Enable"]
pub type TCEI_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type MCEO0_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type MCEO1_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
impl R {
