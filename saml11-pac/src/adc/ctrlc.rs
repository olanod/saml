...
pub type DIFFMODE_W<'a, const O: u8> = crate::BitWriter<'a, CTRLC_SPEC, O>;
...
pub type LEFTADJ_W<'a, const O: u8> = crate::BitWriter<'a, CTRLC_SPEC, O>;
#[doc = "Field `FREERUN` reader - Free Running Mode"]
pub type FREERUN_R = crate::BitReader;
#[doc = "Field `FREERUN` writer - Free Running Mode"]
pub type FREERUN_W<'a, const O: u8> = crate::BitWriter<'a, CTRLC_SPEC, O>;
...
pub type CORREN_W<'a, const O: u8> = crate::BitWriter<'a, CTRLC_SPEC, O>;
...
pub type RESSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CTRLC_SPEC, 2, O, RESSELSELECT_A>;
...
pub type R2R_W<'a, const O: u8> = crate::BitWriter<'a, CTRLC_SPEC, O>;
...
pub type WINMODE_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLC_SPEC, 3, O, WINMODESELECT_A>;
...
pub type DUALSEL_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLC_SPEC, 2, O, DUALSELSELECT_A>;
