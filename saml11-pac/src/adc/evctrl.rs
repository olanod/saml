...
pub type FLUSHEI_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type FLUSHINV_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type STARTINV_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type RESRDYEO_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
...
pub type WINMONEO_W<'a, const O: u8> = crate::BitWriter<'a, EVCTRL_SPEC, O>;
impl R {
