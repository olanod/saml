...
pub type ACTION_W<'a, const O: u8> = crate::FieldWriterSafe<'a, BOD33_SPEC, 2, O, ACTIONSELECT_A>;
...
pub type STDBYCFG_W<'a, const O: u8> = crate::BitWriter<'a, BOD33_SPEC, O>;
...
pub type ACTCFG_W<'a, const O: u8> = crate::BitWriter<'a, BOD33_SPEC, O>;
#[doc = "Field `REFSEL` reader - BOD33 Voltage Reference Selection"]
pub type REFSEL_R = crate::BitReader<REFSELSELECT_A>;
...
impl From<REFSELSELECT_A> for bool {
    #[inline(always)]
...
impl REFSEL_R {
    ...
    pub fn variant(&self) -> REFSELSELECT_A {
        match self.bits {
            false => REFSELSELECT_A::SEL_VREFDETREF,
            true => REFSELSELECT_A::SEL_ULPVREF,
        }
    }
    #[doc = "Checks if the value of the field is `SEL_VREFDETREF`"]
    #[inline(always)]
    pub fn is_sel_vrefdetref(&self) -> bool {
        *self == REFSELSELECT_A::SEL_VREFDETREF
    }
    #[doc = "Checks if the value of the field is `SEL_ULPVREF`"]
    #[inline(always)]
    pub fn is_sel_ulpvref(&self) -> bool {
        *self == REFSELSELECT_A::SEL_ULPVREF
    }
}
#[doc = "Field `REFSEL` writer - BOD33 Voltage Reference Selection"]
pub type REFSEL_W<'a, const O: u8> = crate::BitWriter<'a, BOD33_SPEC, O, REFSELSELECT_A>;
impl<'a, const O: u8> REFSEL_W<'a, O> {
    #[doc = "Selects VREFDETREF for the BOD33"]
    #[inline(always)]
    pub fn sel_vrefdetref(self) -> &'a mut W {
        self.variant(REFSELSELECT_A::SEL_VREFDETREF)
    }
    #[doc = "Selects ULPVREF for the BOD33"]
    #[inline(always)]
    pub fn sel_ulpvref(self) -> &'a mut W {
        self.variant(REFSELSELECT_A::SEL_ULPVREF)
    }
}
...
pub type PSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, BOD33_SPEC, 4, O, PSELSELECT_A>;
