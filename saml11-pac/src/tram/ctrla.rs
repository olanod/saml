...
pub type TAMPERS_R = crate::BitReader;
#[doc = "Field `TAMPERS` writer - Tamper Erase"]
pub type TAMPERS_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
...
pub type DRP_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
#[doc = "Field `SILACC` reader - Silent Access"]
pub type SILACC_R = crate::BitReader;
#[doc = "Field `SILACC` writer - Silent Access"]
pub type SILACC_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tampers(&mut self) -> TAMPERS_W<4> {
        TAMPERS_W::new(self)
    }
    #[doc = "Bit 6 - Data Remanence Prevention"]
    #[inline(always)]
    #[must_use]
    pub fn drp(&mut self) -> DRP_W<6> {
        DRP_W::new(self)
    }
    #[doc = "Bit 7 - Silent Access"]
    #[inline(always)]
    #[must_use]
    pub fn silacc(&mut self) -> SILACC_W<7> {
        SILACC_W::new(self)
    }
