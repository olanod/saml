...
pub type CRCBEATSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, CRCCTRL_SPEC, 2, O, CRCBEATSIZESELECT_A>;
...
pub type CRCPOLY_W<'a, const O: u8> = crate::FieldWriter<'a, CRCCTRL_SPEC, 2, O, CRCPOLYSELECT_A>;
...
pub type CRCSRC_W<'a, const O: u8> = crate::FieldWriter<'a, CRCCTRL_SPEC, 6, O, CRCSRCSELECT_A>;
