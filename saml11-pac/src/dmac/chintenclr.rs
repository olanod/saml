...
pub type TERR_W<'a, const O: u8> = crate::BitWriter<'a, CHINTENCLR_SPEC, O>;
...
pub type TCMPL_W<'a, const O: u8> = crate::BitWriter<'a, CHINTENCLR_SPEC, O>;
...
pub type SUSP_W<'a, const O: u8> = crate::BitWriter<'a, CHINTENCLR_SPEC, O>;
impl R {
