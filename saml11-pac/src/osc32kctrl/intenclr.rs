...
pub type XOSC32KRDY_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
#[doc = "Field `CLKFAIL` reader - XOSC32K Clock Failure Detector Interrupt Enable"]
pub type CLKFAIL_R = crate::BitReader;
#[doc = "Field `CLKFAIL` writer - XOSC32K Clock Failure Detector Interrupt Enable"]
pub type CLKFAIL_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
impl R {
