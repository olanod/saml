...
pub type CFDEN_W<'a, const O: u8> = crate::BitWriter<'a, CFDCTRL_SPEC, O>;
#[doc = "Field `SWBACK` reader - Clock Switch Back"]
pub type SWBACK_R = crate::BitReader;
#[doc = "Field `SWBACK` writer - Clock Switch Back"]
pub type SWBACK_W<'a, const O: u8> = crate::BitWriter<'a, CFDCTRL_SPEC, O>;
...
pub type CFDPRESC_W<'a, const O: u8> = crate::BitWriter<'a, CFDCTRL_SPEC, O>;
impl R {
