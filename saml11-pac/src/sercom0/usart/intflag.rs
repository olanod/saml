...
pub type DRE_W<'a, const O: u8> = crate::BitWriter<'a, INTFLAG_SPEC, O>;
...
pub type RXC_W<'a, const O: u8> = crate::BitWriter<'a, INTFLAG_SPEC, O>;
...
pub type CTSIC_W<'a, const O: u8> = crate::BitWriter<'a, INTFLAG_SPEC, O>;
...
pub type RXBRK_W<'a, const O: u8> = crate::BitWriter<'a, INTFLAG_SPEC, O>;
...
pub type ERROR_W<'a, const O: u8> = crate::BitWriter<'a, INTFLAG_SPEC, O>;
impl R {
