...
pub type COLDEN_W<'a, const O: u8> = crate::BitWriter<'a, CTRLB_SPEC, O>;
...
pub type ENC_W<'a, const O: u8> = crate::BitWriter<'a, CTRLB_SPEC, O>;
...
pub type LINCMD_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLB_SPEC, 2, O>;
impl R {
