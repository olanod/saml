...
pub type TENBITEN_W<'a, const O: u8> = crate::BitWriter<'a, ADDR_SPEC, O>;
#[doc = "Field `LEN` reader - Length"]
pub type LEN_R = crate::FieldReader;
#[doc = "Field `LEN` writer - Length"]
pub type LEN_W<'a, const O: u8> = crate::FieldWriter<'a, ADDR_SPEC, 8, O>;
impl R {
