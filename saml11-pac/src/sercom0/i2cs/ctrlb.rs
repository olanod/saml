...
pub type SMEN_W<'a, const O: u8> = crate::BitWriter<'a, CTRLB_SPEC, O>;
#[doc = "Field `GCMD` reader - PMBus Group Command"]
pub type GCMD_R = crate::BitReader;
#[doc = "Field `GCMD` writer - PMBus Group Command"]
pub type GCMD_W<'a, const O: u8> = crate::BitWriter<'a, CTRLB_SPEC, O>;
