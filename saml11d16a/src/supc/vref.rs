...
pub type VREFOE_W<'a, const O: u8> = crate::BitWriter<'a, VREF_SPEC, O>;
...
pub type TSSEL_W<'a, const O: u8> = crate::BitWriter<'a, VREF_SPEC, O>;
#[doc = "Field `RUNSTDBY` reader - Run during Standby"]
pub type RUNSTDBY_R = crate::BitReader;
#[doc = "Field `RUNSTDBY` writer - Run during Standby"]
pub type RUNSTDBY_W<'a, const O: u8> = crate::BitWriter<'a, VREF_SPEC, O>;
...
pub type ONDEMAND_W<'a, const O: u8> = crate::BitWriter<'a, VREF_SPEC, O>;
...
pub type SEL_W<'a, const O: u8> = crate::FieldWriter<'a, VREF_SPEC, 4, O, SELSELECT_A>;
