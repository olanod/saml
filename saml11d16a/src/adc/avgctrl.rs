...
pub type SAMPLENUM_W<'a, const O: u8> = crate::FieldWriter<'a, AVGCTRL_SPEC, 4, O, SAMPLENUMSELECT_A>;
...
pub type ADJRES_W<'a, const O: u8> = crate::FieldWriter<'a, AVGCTRL_SPEC, 3, O>;
impl R {
