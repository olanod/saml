...
pub type TERR_W<'a, const O: u8> = crate::BitWriter<'a, CHINTFLAG_SPEC, O>;
...
pub type TCMPL_W<'a, const O: u8> = crate::BitWriter<'a, CHINTFLAG_SPEC, O>;
#[doc = "Field `SUSP` reader - Channel Suspend"]
pub type SUSP_R = crate::BitReader;
#[doc = "Field `SUSP` writer - Channel Suspend"]
pub type SUSP_W<'a, const O: u8> = crate::BitWriter<'a, CHINTFLAG_SPEC, O>;
impl R {
