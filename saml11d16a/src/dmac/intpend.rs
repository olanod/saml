...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ferr(&mut self) -> FERR_W<13> {
        FERR_W::new(self)
    }
    #[doc = "Bit 14 - Busy"]
    #[inline(always)]
    #[must_use]
    pub fn busy(&mut self) -> BUSY_W<14> {
        BUSY_W::new(self)
    }
    #[doc = "Bit 15 - Pending"]
    #[inline(always)]
    #[must_use]
    pub fn pend(&mut self) -> PEND_W<15> {
        PEND_W::new(self)
    }
