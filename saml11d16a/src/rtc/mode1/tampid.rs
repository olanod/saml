...
pub type TAMPID0_W<'a, const O: u8> = crate::BitWriter<'a, TAMPID_SPEC, O>;
...
pub type TAMPID1_W<'a, const O: u8> = crate::BitWriter<'a, TAMPID_SPEC, O>;
...
pub type TAMPID2_W<'a, const O: u8> = crate::BitWriter<'a, TAMPID_SPEC, O>;
...
pub type TAMPID3_W<'a, const O: u8> = crate::BitWriter<'a, TAMPID_SPEC, O>;
...
pub type TAMPEVT_W<'a, const O: u8> = crate::BitWriter<'a, TAMPID_SPEC, O>;
impl R {
