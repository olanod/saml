...
pub type STOP_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
#[doc = "Field `SLAVE` reader - Slave Status Flag"]
pub type SLAVE_R = crate::BitReader;
#[doc = "Field `SLAVE` writer - Slave Status Flag"]
pub type SLAVE_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
...
pub type PERBUFV_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
...
pub type CCBUFV0_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
...
pub type CCBUFV1_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
impl R {
