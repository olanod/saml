...
pub type DIR_W<'a, const O: u8> = crate::BitWriter<'a, CTRLBSET_SPEC, O>;
#[doc = "Field `LUPD` reader - Lock Update"]
pub type LUPD_R = crate::BitReader;
#[doc = "Field `LUPD` writer - Lock Update"]
pub type LUPD_W<'a, const O: u8> = crate::BitWriter<'a, CTRLBSET_SPEC, O>;
...
pub type ONESHOT_W<'a, const O: u8> = crate::BitWriter<'a, CTRLBSET_SPEC, O>;
...
pub type CMD_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLBSET_SPEC, 3, O, CMDSELECT_A>;
