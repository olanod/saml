...
pub type SWRST_W<'a, const O: u8> = crate::BitWriter<'a, CHCTRLA_SPEC, O>;
#[doc = "Field `ENABLE` reader - Channel Enable"]
pub type ENABLE_R = crate::BitReader;
#[doc = "Field `ENABLE` writer - Channel Enable"]
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, CHCTRLA_SPEC, O>;
#[doc = "Field `RUNSTDBY` reader - Channel run in standby"]
pub type RUNSTDBY_R = crate::BitReader;
#[doc = "Field `RUNSTDBY` writer - Channel run in standby"]
pub type RUNSTDBY_W<'a, const O: u8> = crate::BitWriter<'a, CHCTRLA_SPEC, O>;
impl R {
