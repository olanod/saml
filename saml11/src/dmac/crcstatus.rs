...
pub type CRCBUSY_W<'a, const O: u8> = crate::BitWriter<'a, CRCSTATUS_SPEC, O>;
#[doc = "Field `CRCZERO` reader - CRC Zero"]
pub type CRCZERO_R = crate::BitReader;
#[doc = "Field `CRCZERO` writer - CRC Zero"]
pub type CRCZERO_W<'a, const O: u8> = crate::BitWriter<'a, CRCSTATUS_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn crczero(&mut self) -> CRCZERO_W<1> {
        CRCZERO_W::new(self)
    }
