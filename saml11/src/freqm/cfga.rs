...
pub type REFNUM_W<'a, const O: u8> = crate::FieldWriter<'a, CFGA_SPEC, 8, O>;
#[doc = "Field `DIVREF` reader - Divide Reference Clock"]
pub type DIVREF_R = crate::BitReader;
#[doc = "Field `DIVREF` writer - Divide Reference Clock"]
pub type DIVREF_W<'a, const O: u8> = crate::BitWriter<'a, CFGA_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn divref(&mut self) -> DIVREF_W<15> {
        DIVREF_W::new(self)
    }
