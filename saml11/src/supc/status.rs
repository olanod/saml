...
#[doc = "Field `ULPBIASRDY` reader - Low Power Voltage Bias Ready"]
pub type ULPBIASRDY_R = crate::BitReader;
impl R {
    ...
    #[doc = "Bit 13 - Low Power Voltage Bias Ready"]
    #[inline(always)]
    pub fn ulpbiasrdy(&self) -> ULPBIASRDY_R {
        ULPBIASRDY_R::new(((self.bits >> 13) & 1) != 0)
    }
}
