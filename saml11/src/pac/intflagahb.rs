...
pub type FLASH__W<'a, const O: u8> = crate::BitWriter<'a, INTFLAGAHB_SPEC, O>;
#[doc = "Field `HPB0_` reader - HPB0"]
pub type HPB0__R = crate::BitReader;
#[doc = "Field `HPB0_` writer - HPB0"]
pub type HPB0__W<'a, const O: u8> = crate::BitWriter<'a, INTFLAGAHB_SPEC, O>;
#[doc = "Field `HPB1_` reader - HPB1"]
pub type HPB1__R = crate::BitReader;
#[doc = "Field `HPB1_` writer - HPB1"]
pub type HPB1__W<'a, const O: u8> = crate::BitWriter<'a, INTFLAGAHB_SPEC, O>;
#[doc = "Field `HPB2_` reader - HPB2"]
pub type HPB2__R = crate::BitReader;
#[doc = "Field `HPB2_` writer - HPB2"]
pub type HPB2__W<'a, const O: u8> = crate::BitWriter<'a, INTFLAGAHB_SPEC, O>;
#[doc = "Field `HSRAMCPU_` reader - HSRAMCPU"]
pub type HSRAMCPU__R = crate::BitReader;
#[doc = "Field `HSRAMCPU_` writer - HSRAMCPU"]
pub type HSRAMCPU__W<'a, const O: u8> = crate::BitWriter<'a, INTFLAGAHB_SPEC, O>;
#[doc = "Field `HSRAMDMAC_` reader - HSRAMDMAC"]
pub type HSRAMDMAC__R = crate::BitReader;
#[doc = "Field `HSRAMDMAC_` writer - HSRAMDMAC"]
pub type HSRAMDMAC__W<'a, const O: u8> = crate::BitWriter<'a, INTFLAGAHB_SPEC, O>;
#[doc = "Field `HSRAMDSU_` reader - HSRAMDSU"]
pub type HSRAMDSU__R = crate::BitReader;
#[doc = "Field `HSRAMDSU_` writer - HSRAMDSU"]
pub type HSRAMDSU__W<'a, const O: u8> = crate::BitWriter<'a, INTFLAGAHB_SPEC, O>;
impl R {
    #[doc = "Bit 0 - FLASH"]
    #[inline(always)]
    ...
    pub fn hpb0_(&self) -> HPB0__R {
        HPB0__R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - HPB1"]
    #[inline(always)]
    pub fn hpb1_(&self) -> HPB1__R {
        HPB1__R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - HPB2"]
    #[inline(always)]
    pub fn hpb2_(&self) -> HPB2__R {
        HPB2__R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - HSRAMCPU"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hpb0_(&mut self) -> HPB0__W<1> {
        HPB0__W::new(self)
    }
    #[doc = "Bit 2 - HPB1"]
    #[inline(always)]
    #[must_use]
    pub fn hpb1_(&mut self) -> HPB1__W<2> {
        HPB1__W::new(self)
    }
    #[doc = "Bit 3 - HPB2"]
    #[inline(always)]
    #[must_use]
    pub fn hpb2_(&mut self) -> HPB2__W<3> {
        HPB2__W::new(self)
    }
    #[doc = "Bit 4 - HSRAMCPU"]
    #[inline(always)]
    #[must_use]
    pub fn hsramcpu_(&mut self) -> HSRAMCPU__W<4> {
        HSRAMCPU__W::new(self)
    }
    #[doc = "Bit 5 - HSRAMDMAC"]
    #[inline(always)]
    #[must_use]
    pub fn hsramdmac_(&mut self) -> HSRAMDMAC__W<5> {
        HSRAMDMAC__W::new(self)
    }
    #[doc = "Bit 6 - HSRAMDSU"]
    #[inline(always)]
    #[must_use]
    pub fn hsramdsu_(&mut self) -> HSRAMDSU__W<6> {
