...
pub type EVGEN_W<'a, const O: u8> = crate::FieldWriter<'a, CHANNEL_SPEC, 6, O>;
...
pub type PATH_W<'a, const O: u8> = crate::FieldWriter<'a, CHANNEL_SPEC, 2, O, PATHSELECT_A>;
...
pub type EDGSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CHANNEL_SPEC, 2, O, EDGSELSELECT_A>;
...
pub type RUNSTDBY_W<'a, const O: u8> = crate::BitWriter<'a, CHANNEL_SPEC, O>;
...
pub type ONDEMAND_W<'a, const O: u8> = crate::BitWriter<'a, CHANNEL_SPEC, O>;
impl R {
