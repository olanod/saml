...
pub type GEN_W<'a, const O: u8> = crate::FieldWriter<'a, PCHCTRL_SPEC, 3, O, GENSELECT_A>;
...
pub type CHEN_W<'a, const O: u8> = crate::BitWriter<'a, PCHCTRL_SPEC, O>;
#[doc = "Field `WRTLOCK` reader - Write Lock"]
pub type WRTLOCK_R = crate::BitReader;
#[doc = "Field `WRTLOCK` writer - Write Lock"]
pub type WRTLOCK_W<'a, const O: u8> = crate::BitWriter<'a, PCHCTRL_SPEC, O>;
impl R {
