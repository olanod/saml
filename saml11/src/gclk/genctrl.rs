...
impl SRC_R {
    ...
    pub fn variant(&self) -> SRCSELECT_A {
        match self.bits {
            ...
            6 => SRCSELECT_A::DFLLULP,
            7 => SRCSELECT_A::FDPLL96M,
            _ => unreachable!(),
        }
    }
    ...
    pub fn is_dfllulp(&self) -> bool {
        *self == SRCSELECT_A::DFLLULP
    }
    #[doc = "Checks if the value of the field is `FDPLL96M`"]
    #[inline(always)]
    pub fn is_fdpll96m(&self) -> bool {
        *self == SRCSELECT_A::FDPLL96M
    }
}
#[doc = "Field `SRC` writer - Source Select"]
pub type SRC_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GENCTRL_SPEC, 3, O, SRCSELECT_A>;
impl<'a, const O: u8> SRC_W<'a, O> {
    ...
    pub fn dfllulp(self) -> &'a mut W {
        self.variant(SRCSELECT_A::DFLLULP)
    }
    #[doc = "FDPLL output"]
    #[inline(always)]
    pub fn fdpll96m(self) -> &'a mut W {
        self.variant(SRCSELECT_A::FDPLL96M)
    }
}
