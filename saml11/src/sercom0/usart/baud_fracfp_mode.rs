...
pub type BAUD_W<'a, const O: u8> = crate::FieldWriter<'a, BAUD_FRACFP_MODE_SPEC, 13, O, u16>;
#[doc = "Field `FP` reader - Fractional Part"]
pub type FP_R = crate::FieldReader;
#[doc = "Field `FP` writer - Fractional Part"]
pub type FP_W<'a, const O: u8> = crate::FieldWriter<'a, BAUD_FRACFP_MODE_SPEC, 3, O>;
impl R {
