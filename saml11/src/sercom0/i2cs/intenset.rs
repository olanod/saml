...
pub type PREC_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
...
pub type AMATCH_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
#[doc = "Field `DRDY` reader - Data Interrupt Enable"]
pub type DRDY_R = crate::BitReader;
#[doc = "Field `DRDY` writer - Data Interrupt Enable"]
pub type DRDY_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O>;
