...
impl RTCSEL_R {
    ...
    pub fn variant(&self) -> Option<RTCSELSELECT_A> {
        match self.bits {
            ...
            2 => Some(RTCSELSELECT_A::OSC1K),
            3 => Some(RTCSELSELECT_A::OSC32K),
...
pub type RTCSEL_W<'a, const O: u8> = crate::FieldWriter<'a, RTCCTRL_SPEC, 3, O, RTCSELSELECT_A>;
