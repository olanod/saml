...
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, COMPCTRL_SPEC, O>;
#[doc = "Field `SINGLE` reader - Single-Shot Mode"]
pub type SINGLE_R = crate::BitReader;
#[doc = "Field `SINGLE` writer - Single-Shot Mode"]
pub type SINGLE_W<'a, const O: u8> = crate::BitWriter<'a, COMPCTRL_SPEC, O>;
...
pub type INTSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, COMPCTRL_SPEC, 2, O, INTSELSELECT_A>;
...
pub type RUNSTDBY_W<'a, const O: u8> = crate::BitWriter<'a, COMPCTRL_SPEC, O>;
...
pub enum MUXNEGSELECT_A {
    ...
    BANDGAP = 6,
    #[doc = "7: DAC or OPAMP output (on AC0/AC1)"]
    DAC_OPAMP = 7,
}
...
impl MUXNEG_R {
    ...
    pub fn variant(&self) -> Option<MUXNEGSELECT_A> {
        match self.bits {
            ...
            4 => Some(MUXNEGSELECT_A::GND),
            5 => Some(MUXNEGSELECT_A::VSCALE),
            6 => Some(MUXNEGSELECT_A::BANDGAP),
            7 => Some(MUXNEGSELECT_A::DAC_OPAMP),
            _ => None,
        }
    }
...
pub type MUXNEG_W<'a, const O: u8> = crate::FieldWriter<'a, COMPCTRL_SPEC, 3, O, MUXNEGSELECT_A>;
impl<'a, const O: u8> MUXNEG_W<'a, O> {
    ...
    pub fn opamp(self) -> &'a mut W {
        self.variant(MUXNEGSELECT_A::DAC_OPAMP)
    }
...
pub type MUXPOS_W<'a, const O: u8> = crate::FieldWriter<'a, COMPCTRL_SPEC, 3, O, MUXPOSSELECT_A>;
...
pub type SWAP_W<'a, const O: u8> = crate::BitWriter<'a, COMPCTRL_SPEC, O>;
...
impl SPEED_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> SPEEDSELECT_A {
        match self.bits {
            0 => SPEEDSELECT_A::LOW,
            1 => SPEEDSELECT_A::MEDLOW,
            2 => SPEEDSELECT_A::MEDHIGH,
            3 => SPEEDSELECT_A::HIGH,
            _ => unreachable!(),
        }
    }
...
pub type SPEED_W<'a, const O: u8> = crate::FieldWriterSafe<'a, COMPCTRL_SPEC, 2, O, SPEEDSELECT_A>;
impl<'a, const O: u8> SPEED_W<'a, O> {
    ...
    pub fn medlow(self) -> &'a mut W {
        self.variant(SPEEDSELECT_A::MEDLOW)
    }
    #[doc = "Medium high speed"]
    #[inline(always)]
    pub fn medhigh(self) -> &'a mut W {
        self.variant(SPEEDSELECT_A::MEDHIGH)
    }
    #[doc = "High speed"]
    #[inline(always)]
...
pub type HYSTEN_W<'a, const O: u8> = crate::BitWriter<'a, COMPCTRL_SPEC, O>;
...
impl HYST_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> HYSTSELECT_A {
        match self.bits {
            0 => HYSTSELECT_A::HYST50,
            1 => HYSTSELECT_A::HYST70,
            2 => HYSTSELECT_A::HYST90,
            3 => HYSTSELECT_A::HYST110,
            _ => unreachable!(),
        }
    }
...
impl<'a, const O: u8> HYST_W<'a, O> {
    ...
    pub fn hyst70(self) -> &'a mut W {
        self.variant(HYSTSELECT_A::HYST70)
    }
    #[doc = "90mV"]
    #[inline(always)]
    pub fn hyst90(self) -> &'a mut W {
        self.variant(HYSTSELECT_A::HYST90)
    }
    #[doc = "110mV"]
    #[inline(always)]
    pub fn hyst110(self) -> &'a mut W {
        self.variant(HYSTSELECT_A::HYST110)
    }
}
...
pub type FLEN_W<'a, const O: u8> = crate::FieldWriter<'a, COMPCTRL_SPEC, 3, O, FLENSELECT_A>;
...
pub type OUT_W<'a, const O: u8> = crate::FieldWriter<'a, COMPCTRL_SPEC, 2, O, OUTSELECT_A>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn single(&mut self) -> SINGLE_W<2> {
        SINGLE_W::new(self)
    }
    #[doc = "Bits 3:4 - Interrupt Selection"]
    #[inline(always)]
    #[must_use]
    pub fn intsel(&mut self) -> INTSEL_W<3> {
        INTSEL_W::new(self)
    }
    #[doc = "Bit 6 - Run in Standby"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn speed(&mut self) -> SPEED_W<16> {
        SPEED_W::new(self)
    }
    #[doc = "Bit 19 - Hysteresis Enable"]
    #[inline(always)]
    #[must_use]
    pub fn hysten(&mut self) -> HYSTEN_W<19> {
        HYSTEN_W::new(self)
    }
    #[doc = "Bits 20:21 - Hysteresis Level"]
    #[inline(always)]
    #[must_use]
    pub fn hyst(&mut self) -> HYST_W<20> {
        HYST_W::new(self)
    }
    #[doc = "Bits 24:26 - Filter Length"]
    #[inline(always)]
