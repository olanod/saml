...
pub type PLSEL_R = crate::FieldReader<PLSELSELECT_A>;
...
impl crate::FieldSpec for PLSELSELECT_A {
    type Ux = u8;
}
impl PLSEL_R {
...
pub type PLSEL_W<'a, const O: u8> = crate::FieldWriter<'a, PLCFG_SPEC, 2, O, PLSELSELECT_A>;
...
pub type PLDIS_R = crate::BitReader;
#[doc = "Field `PLDIS` writer - Performance Level Disable"]
pub type PLDIS_W<'a, const O: u8> = crate::BitWriter<'a, PLCFG_SPEC, O>;
impl R {
