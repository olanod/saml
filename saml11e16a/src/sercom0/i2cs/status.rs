...
pub type DIR_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
#[doc = "Field `SR` reader - Repeated Start"]
pub type SR_R = crate::BitReader;
#[doc = "Field `SR` writer - Repeated Start"]
pub type SR_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
...
pub type HS_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
impl R {
    #[doc = "Bit 0 - Bus Error"]
    #[inline(always)]
