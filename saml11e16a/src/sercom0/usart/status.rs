...
pub type TXE_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
...
pub type ITER_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
impl R {
