...
pub type ARBLOST_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
...
pub type RXNACK_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
#[doc = "Field `BUSSTATE` reader - Bus State"]
pub type BUSSTATE_R = crate::FieldReader;
#[doc = "Field `BUSSTATE` writer - Bus State"]
pub type BUSSTATE_W<'a, const O: u8> = crate::FieldWriter<'a, STATUS_SPEC, 2, O>;
...
pub type CLKHOLD_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
...
pub type MEXTTOUT_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
...
pub type SEXTTOUT_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
#[doc = "Field `LENERR` reader - Length Error"]
pub type LENERR_R = crate::BitReader;
#[doc = "Field `LENERR` writer - Length Error"]
pub type LENERR_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
impl R {
    #[doc = "Bit 0 - Bus Error"]
    #[inline(always)]
