...
pub type WRBQOS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, QOSCTRL_SPEC, 2, O, WRBQOSSELECT_A>;
...
pub type FQOS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, QOSCTRL_SPEC, 2, O, FQOSSELECT_A>;
...
pub type DQOS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, QOSCTRL_SPEC, 2, O, DQOSSELECT_A>;
