...
pub type DMAENABLE_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
#[doc = "Field `CRCENABLE` reader - CRC Enable"]
pub type CRCENABLE_R = crate::BitReader;
#[doc = "Field `CRCENABLE` writer - CRC Enable"]
pub type CRCENABLE_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
...
pub type LVLEN0_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
...
pub type LVLEN1_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
...
pub type LVLEN2_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
...
pub type LVLEN3_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
impl R {
