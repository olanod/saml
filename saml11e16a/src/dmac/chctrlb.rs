...
pub type EVACT_W<'a, const O: u8> = crate::FieldWriter<'a, CHCTRLB_SPEC, 3, O, EVACTSELECT_A>;
...
pub type EVIE_W<'a, const O: u8> = crate::BitWriter<'a, CHCTRLB_SPEC, O>;
...
pub type EVOE_W<'a, const O: u8> = crate::BitWriter<'a, CHCTRLB_SPEC, O>;
...
pub type LVL_W<'a, const O: u8> = crate::FieldWriter<'a, CHCTRLB_SPEC, 2, O>;
...
pub type TRIGSRC_W<'a, const O: u8> = crate::FieldWriter<'a, CHCTRLB_SPEC, 5, O, TRIGSRCSELECT_A>;
...
pub type TRIGACT_W<'a, const O: u8> = crate::FieldWriter<'a, CHCTRLB_SPEC, 2, O, TRIGACTSELECT_A>;
...
pub type CMD_W<'a, const O: u8> = crate::FieldWriter<'a, CHCTRLB_SPEC, 2, O, CMDSELECT_A>;
