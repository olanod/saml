...
pub type CLKREP_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
#[doc = "Field `MATCHCLR` reader - Clear on Match"]
pub type MATCHCLR_R = crate::BitReader;
#[doc = "Field `MATCHCLR` writer - Clear on Match"]
pub type MATCHCLR_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
...
pub type PRESCALER_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLA_SPEC, 4, O, PRESCALERSELECT_A>;
...
pub type GPTRST_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
...
pub type CLOCKSYNC_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clkrep(&mut self) -> CLKREP_W<6> {
        CLKREP_W::new(self)
    }
    #[doc = "Bit 7 - Clear on Match"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn clocksync(&mut self) -> CLOCKSYNC_W<15> {
