...
pub type PER0_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
...
pub type PER1_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
...
pub type PER2_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
...
pub type PER3_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
...
pub type PER4_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
...
pub type PER5_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
...
pub type PER6_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
...
pub type PER7_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
...
pub type CMP0_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
...
pub type CMP1_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
#[doc = "Field `TAMPER` reader - Tamper Enable"]
pub type TAMPER_R = crate::BitReader;
#[doc = "Field `TAMPER` writer - Tamper Enable"]
pub type TAMPER_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
...
pub type OVF_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O>;
impl R {
