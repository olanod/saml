...
pub type DOPO_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLA_SPEC, 2, O>;
#[doc = "Field `DIPO` reader - Data In Pinout"]
pub type DIPO_R = crate::FieldReader;
#[doc = "Field `DIPO` writer - Data In Pinout"]
pub type DIPO_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLA_SPEC, 2, O>;
...
pub type CPHA_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
