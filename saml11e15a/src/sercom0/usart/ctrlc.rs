...
pub type GTIME_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLC_SPEC, 3, O>;
...
pub type BRKLEN_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLC_SPEC, 2, O>;
...
pub type HDRDLY_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLC_SPEC, 2, O>;
...
pub type INACK_W<'a, const O: u8> = crate::BitWriter<'a, CTRLC_SPEC, O>;
...
pub type DSNACK_W<'a, const O: u8> = crate::BitWriter<'a, CTRLC_SPEC, O>;
...
pub type MAXITER_W<'a, const O: u8> = crate::FieldWriter<'a, CTRLC_SPEC, 3, O>;
impl R {
