...
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, LUTCTRL_SPEC, O>;
...
pub type FILTSEL_W<'a, const O: u8> = crate::FieldWriter<'a, LUTCTRL_SPEC, 2, O, FILTSELSELECT_A>;
...
pub type EDGESEL_W<'a, const O: u8> = crate::BitWriter<'a, LUTCTRL_SPEC, O>;
...
impl INSEL0_R {
    ...
    pub fn variant(&self) -> Option<INSEL0SELECT_A> {
        match self.bits {
            ...
            10 => Some(INSEL0SELECT_A::ALT2TC),
            11 => Some(INSEL0SELECT_A::ASYNCEVENT),
            _ => None,
        }
    }
    ...
    pub fn is_alt2tc(&self) -> bool {
        *self == INSEL0SELECT_A::ALT2TC
    }
    #[doc = "Checks if the value of the field is `ASYNCEVENT`"]
    #[inline(always)]
    pub fn is_asyncevent(&self) -> bool {
        *self == INSEL0SELECT_A::ASYNCEVENT
    }
}
#[doc = "Field `INSEL0` writer - Input Selection 0"]
pub type INSEL0_W<'a, const O: u8> = crate::FieldWriter<'a, LUTCTRL_SPEC, 4, O, INSEL0SELECT_A>;
...
impl INSEL1_R {
    ...
    pub fn variant(&self) -> Option<INSEL1SELECT_A> {
        match self.bits {
            ...
            10 => Some(INSEL1SELECT_A::ALT2TC),
            11 => Some(INSEL1SELECT_A::ASYNCEVENT),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `MASK`"]
    ...
    #[inline(always)]
    pub fn is_alt2tc(&self) -> bool {
        *self == INSEL1SELECT_A::ALT2TC
    }
    #[doc = "Checks if the value of the field is `ASYNCEVENT`"]
    #[inline(always)]
    pub fn is_asyncevent(&self) -> bool {
        *self == INSEL1SELECT_A::ASYNCEVENT
    }
}
#[doc = "Field `INSEL1` writer - Input Selection 1"]
pub type INSEL1_W<'a, const O: u8> = crate::FieldWriter<'a, LUTCTRL_SPEC, 4, O, INSEL1SELECT_A>;
impl<'a, const O: u8> INSEL1_W<'a, O> {
    ...
    #[inline(always)]
    pub fn alt2tc(self) -> &'a mut W {
        self.variant(INSEL1SELECT_A::ALT2TC)
    }
    #[doc = "Asynchronous event input source. The EVENT input will bypass edge detection logic."]
    #[inline(always)]
    pub fn asyncevent(self) -> &'a mut W {
        self.variant(INSEL1SELECT_A::ASYNCEVENT)
    }
}
...
impl INSEL2_R {
    ...
    pub fn variant(&self) -> Option<INSEL2SELECT_A> {
        match self.bits {
            ...
            10 => Some(INSEL2SELECT_A::ALT2TC),
            11 => Some(INSEL2SELECT_A::ASYNCEVENT),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `MASK`"]
    ...
    #[inline(always)]
    pub fn is_alt2tc(&self) -> bool {
        *self == INSEL2SELECT_A::ALT2TC
    }
    #[doc = "Checks if the value of the field is `ASYNCEVENT`"]
    #[inline(always)]
    pub fn is_asyncevent(&self) -> bool {
        *self == INSEL2SELECT_A::ASYNCEVENT
    }
}
#[doc = "Field `INSEL2` writer - Input Selection 2"]
pub type INSEL2_W<'a, const O: u8> = crate::FieldWriter<'a, LUTCTRL_SPEC, 4, O, INSEL2SELECT_A>;
impl<'a, const O: u8> INSEL2_W<'a, O> {
    ...
    #[inline(always)]
    pub fn alt2tc(self) -> &'a mut W {
        self.variant(INSEL2SELECT_A::ALT2TC)
    }
    #[doc = "Asynchronous event input source. The EVENT input will bypass edge detection logic."]
    #[inline(always)]
    pub fn asyncevent(self) -> &'a mut W {
        self.variant(INSEL2SELECT_A::ASYNCEVENT)
    }
}
...
pub type INVEI_W<'a, const O: u8> = crate::BitWriter<'a, LUTCTRL_SPEC, O>;
...
pub type LUTEI_W<'a, const O: u8> = crate::BitWriter<'a, LUTCTRL_SPEC, O>;
...
pub type LUTEO_W<'a, const O: u8> = crate::BitWriter<'a, LUTCTRL_SPEC, O>;
#[doc = "Field `TRUTH` reader - Truth Value"]
pub type TRUTH_R = crate::FieldReader;
#[doc = "Field `TRUTH` writer - Truth Value"]
pub type TRUTH_W<'a, const O: u8> = crate::FieldWriter<'a, LUTCTRL_SPEC, 8, O>;
impl R {
