...
pub type WEN0_W<'a, const O: u8> = crate::BitWriter<'a, WINCTRL_SPEC, O>;
...
pub type WINTSEL0_W<'a, const O: u8> = crate::FieldWriterSafe<'a, WINCTRL_SPEC, 2, O, WINTSEL0SELECT_A>;
