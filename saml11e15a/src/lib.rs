#![doc = "Peripheral access API for ATSAML11E15A microcontrollers (generated using svd2rust v0.29.0 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
pub use cortex_m::peripheral::{
    mpu, nvic, scb, Peripherals as CorePeripherals, CBP, CPUID, DCB, DWT, FPB, ITM, MPU, NVIC, SCB, SYST, TPIU,
};
#[cfg(feature = "rt")]
...
pub static __INTERRUPTS: [Vector; 45] = [
    ...
    Vector { _handler: DMAC_OTHER },
    Vector { _handler: EVSYS_0 },
    Vector { _handler: EVSYS_1 },
    Vector { _handler: EVSYS_2 },
    Vector { _handler: EVSYS_3 },
    Vector { _handler: EVSYS_NSCHK },
    Vector { _handler: PAC },
    Vector { _handler: SERCOM0_0 },
    Vector { _handler: SERCOM0_1 },
    Vector { _handler: SERCOM0_2 },
    Vector {
        _handler: SERCOM0_OTHER,
    },
    Vector { _handler: SERCOM1_0 },
    Vector { _handler: SERCOM1_1 },
    Vector { _handler: SERCOM1_2 },
    Vector {
        _handler: SERCOM1_OTHER,
    },
    Vector { _handler: SERCOM2_0 },
    Vector { _handler: SERCOM2_1 },
    Vector { _handler: SERCOM2_2 },
    Vector {
    ...
    Vector { _handler: TC1 },
    Vector { _handler: TC2 },
    Vector { _handler: ADC_OTHER },
    Vector { _handler: ADC_RESRDY },
    Vector { _handler: AC },
    Vector {
        _handler: DAC_UNDERRUN_A,
    },
    Vector { _handler: DAC_EMPTY },
    Vector { _handler: PTC },
...
impl Peripherals {
    ...
    pub unsafe fn steal() -> Self {
        ...
        Peripherals {
            AC: AC { _marker: PhantomData },
            ADC: ADC { _marker: PhantomData },
            CCL: CCL { _marker: PhantomData },
            DAC: DAC { _marker: PhantomData },
            DMAC: DMAC { _marker: PhantomData },
            DSU: DSU { _marker: PhantomData },
            DSU_EXT: DSU_EXT { _marker: PhantomData },
            EIC: EIC { _marker: PhantomData },
            EIC_SEC: EIC_SEC { _marker: PhantomData },
            EVSYS: EVSYS { _marker: PhantomData },
            EVSYS_SEC: EVSYS_SEC { _marker: PhantomData },
            FREQM: FREQM { _marker: PhantomData },
            GCLK: GCLK { _marker: PhantomData },
            IDAU: IDAU { _marker: PhantomData },
            MCLK: MCLK { _marker: PhantomData },
            NVMCTRL: NVMCTRL { _marker: PhantomData },
            NVMCTRL_SEC: NVMCTRL_SEC { _marker: PhantomData },
            OPAMP: OPAMP { _marker: PhantomData },
            OSCCTRL: OSCCTRL { _marker: PhantomData },
            OSC32KCTRL: OSC32KCTRL { _marker: PhantomData },
            PAC: PAC { _marker: PhantomData },
            PAC_SEC: PAC_SEC { _marker: PhantomData },
            PM: PM { _marker: PhantomData },
            PORT: PORT { _marker: PhantomData },
            PORT_SEC: PORT_SEC { _marker: PhantomData },
            PORT_IOBUS: PORT_IOBUS { _marker: PhantomData },
            PORT_IOBUS_SEC: PORT_IOBUS_SEC { _marker: PhantomData },
            RSTC: RSTC { _marker: PhantomData },
            RTC: RTC { _marker: PhantomData },
            SERCOM0: SERCOM0 { _marker: PhantomData },
            SERCOM1: SERCOM1 { _marker: PhantomData },
            SERCOM2: SERCOM2 { _marker: PhantomData },
            SUPC: SUPC { _marker: PhantomData },
            TC0: TC0 { _marker: PhantomData },
            TC1: TC1 { _marker: PhantomData },
            TC2: TC2 { _marker: PhantomData },
            TRAM: TRAM { _marker: PhantomData },
            TRNG: TRNG { _marker: PhantomData },
            WDT: WDT { _marker: PhantomData },
            CORE_DEBUG: CORE_DEBUG { _marker: PhantomData },
            CORE_DEBUG_NS: CORE_DEBUG_NS { _marker: PhantomData },
            DIB: DIB { _marker: PhantomData },
            DIB_NS: DIB_NS { _marker: PhantomData },
            ICB: ICB { _marker: PhantomData },
            ICB_NS: ICB_NS { _marker: PhantomData },
            MPU_NS: MPU_NS { _marker: PhantomData },
            NVIC_NS: NVIC_NS { _marker: PhantomData },
            SCB_NS: SCB_NS { _marker: PhantomData },
            SYS_TICK: SYS_TICK { _marker: PhantomData },
            SYS_TICK_NS: SYS_TICK_NS { _marker: PhantomData },
        }
    }
}
